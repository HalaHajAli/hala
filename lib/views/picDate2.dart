...
import 'package:flutter_application/views/halltime3.dart';
...
class _CupertinoDatePickerPageState extends State<CupertinoDatePickerPage2> {
  ...
  // Allow choosing dates within the next two weeks
  DateTime maxDate = DateTime.now().add(Duration(days: 14)).date;
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    offerProvider.addToCart(selectedDateTemp.toString());
                    Provider.of<GradProvider>(context, listen: false)
                        .addToGradList(' التاريخ:$selectedDateTemp.toString()');
                    // Show the dialog
                    showDialog(
                      context: context,
