...
class FoodManagementPage extends StatelessWidget {
  final List<Restaurant> restaurants = [
    Restaurant(
        ...
        instagramLink:
            'https://instagram.com/wrestaurantpal?igshid=MXFibnI0ZHB3NWgxcg==',
        imagePath: 'images/w2.png'),
    Restaurant(
        name: 'إكليل الورد',
        contactInfo: 'الهاتف: 123-456-7890',
        facebookLink:
            'https://www.facebook.com/ekleel.alward.ps1?mibextid=ZbWKwL',
        instagramLink:
            'https://instagram.com/ekleel.alward.ps?igshid=ZXljMDdwYjlnNXZr',
  ...
  final List<SweetsPlace> sweetsPlaces = [
    SweetsPlace(
        ...
        contactInfo: 'الهاتف: 123-456-7890',
        facebookLink:
            'https://www.facebook.com/alsaraya.sweets?mibextid=ZbWKwL',
        instagramLink:
            'https://instagram.com/saraya_sweets?igshid=MW9iYnFvZHV6Mm03MA==',
    ...
    SweetsPlace(
        ...
        instagramLink:
            'https://instagram.com/sardchocolate.ps?igshid=cGZkbmF0NzFncmQ1',
  ...
  Widget build(BuildContext context) {
    final reqProvider =
        Provider.of<ReqProvider>(context, listen: false); // Use the ReqProvider
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        reqProvider.addReq(restaurant.name);
            gradProvider.addToGradList('المطعم:$restaurant.name'); // Add the text label when storing in GradProvider
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(
                        16.0), // Adjust the padding values as needed
                    child: ElevatedButton(
                      onPressed: () {
                      ...
                      style: ElevatedButton.styleFrom(
                        primary: Color(
                            0xFF5BA581), // Change the button's background color
                        onPrimary:
